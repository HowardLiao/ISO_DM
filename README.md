...
│                        【四階文件與雙向追溯鏈】                         │
│                                                                        │
│   由上而下落實治理 (Top-Down)                 由下而上舉證稽核 (Bottom-Up)   │
│   一階 Policy (方針與承諾)         ▲         4. 達成組織政策承諾        │
│          │                         │                  ▲                │
│          ▼                         │                  │                │
│   二階 Procedure (流程與內控)       │         3. 檢驗管理制度合規性     │
│          │                         │                  ▲                │
│          ▼                         │                  │                │
│   三階 SOP / WI (操作指導)          │         2. 檢驗第一線操作步驟     │
│          │                         │                  ▲                │
│          ▼                         │                  │                │
│   四階 Record (表單日誌證據)       ▼         1. 拿出不可篡改客觀證據    │
└────────────────────────────────────────────────────────────────────────┘
```

- **一階 (Tier 1) 政策／管理手冊 (Policy)**：回答「**為什麼做、達成什麼？**」，組織最高方針、資安承諾、AI 治理原則。由最高管理層核准，人事・總務文管窗口（芮郗）受控發布。
- **二階 (Tier 2) 程序書／管理辦法 (Procedure)**：回答「**誰做、何時做、如何運作？**」，跨部門流程控制點、RACI 邊界、SLA、交接條件與退件權。由各流程主責 Owner 起草，財務（玉霜）、技術（翊庭、睿修）、總務（芮郗）共同覆核。
- **三階 (Tier 3) 標準作業程序與指導書 (SOP / WI / Runbook)**：回答「**實際上怎麼做？**」，第一線人員具體步驟、指令語法、畫面截圖、防呆驗證與 Rollback 回滾。由技術文管（翊庭、睿修）與執行主管核准。
- **四階 (Tier 4) 表單、台帳、日誌與證據 (Forms & Records)**：回答「**做過了嗎？證據在哪裡？**」，空白表單定義規範，填寫紀錄、Audit Log、會議紀錄與驗收單證明組織真實履約。由經辦與主管簽章留存 Google Shared Drive 04 目錄。
